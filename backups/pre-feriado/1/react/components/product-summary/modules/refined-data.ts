...
export class RefinedData {
  ...
  public getVariants = async (product?: VTEXProduct):Promise<VTEXProduct[]> => {
    ...
    const dataJson:VTEXProduct[] = await data.json()
    ...
    const dataJsonSorted: VTEXProduct[] =
    availableProducts
    ?.sort((a: any, b: any) => {
  ...
  public getQuantityColors(product:VTEXProduct):RefinedDataResponseGetQuantityColors {
  ...
  public getColor(product:VTEXProduct):RefinedDataResponseGetColor {
  ...
  public getSku(product:VTEXProduct):RefinedDataResponseGetSku {
