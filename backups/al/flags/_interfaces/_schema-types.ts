...
export type T_schema_quadrant_name = 'Quadrante - inferior' | 'Quadrante - Esquerda' | 'Quadrante - Direita' | 'Quadrante - Horizontal'
export type T_schema_quadrant_title = 'quadrantTopLeft' | 'quadrantTopRight' | 'quadrantBottom' | 'quadrantHorizontal'
...
export type T_schema_links_to_filter =
  'linksByProduct'
  | 'linksByCollection'
