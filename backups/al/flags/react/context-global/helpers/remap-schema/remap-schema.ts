              ...
              ?.map((collection) => ({
                ...
                badgesStyles: collection?.typeContent === 'image'
                  ...
                  ({
                    ...
                    width: (collection?.items as schema_site_editor_default_option_image[])?.[0]?.commonPropsBetweenContentAndImage?.width ?? 'fit-content',
                  ...
                  ({
                    ...
                    fontSize: ((collection as any)?.items)?.[0]?.fontSize || '14px',
                    lineHeight: ((collection as any)?.items)?.[0]?.lineHeight || '14px',
                    ...
                    width: (collection?.items as schema_site_editor_default_option_content[])?.[0]?.commonPropsBetweenContentAndImage?.width || 'fit-content',
