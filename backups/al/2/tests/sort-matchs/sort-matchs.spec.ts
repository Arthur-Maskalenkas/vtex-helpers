import { mock_list_priority } from "./mocks/sort-matchs"
...
describe('sortMatchs', () => {
  describe('priorityByList', () => {
    ...
    it('Should sort by priorityByList', () => {
      ...
      const result = mock_list_priority.sort((a, b) => sut.sort(a, b, false, 'priorityByList'))

      expect(result).toEqual(mock_list_priority)
    })
  ...
  describe('priorityByField', () => {
    ...
    it('Should sort by priorityByField', () => {
      ...
      const result = mock_list_priority.sort((a, b) => sut.sort(a, b, false, 'priorityByField'))
