...
import { CollectionMocked, generateCollection, generateQuadrant, generateRefinedData } from './mocks/remap-schema'
...
import {
  ...
  , schema_site_editor_default_root_app_badge_custom, ListOfCollection, ListOfVariation
...
import { normalizeString } from '../filter-default-schema/_mocks'
  ...
  describe('Filter Integration', () => {
    ...
    it('Should return collection if matched', () => {
      ...
      const mock_collection_1 = generateCollection({
        title: 'mock-title',
        propertieToLinkOnCtx: mock_propertie_1,
        variant: 'variant-2',
        priority: '50',
        typeContent: 'image',
        isActive: false,
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByProduct: [
              {
                propertieToLinkOnCtx: mock_propertie_1,
                __editorItemTitle: mock_link_id_1
              }
            ]
          }
        ]
            ...
            theLinksPresentsInThisProductContextByCollections: [
              {
                ...
                __editorItemTitle: mock_valid_collection_1.id
              }
            ]
          }
        ]
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByCollections: [
              {
                propertieToLinkOnCtx: "listOfCollections",
                __editorItemTitle: mock_valid_collection_2.id
              }
            ]
          }
        ]
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByCollections: [
              {
                propertieToLinkOnCtx: "listOfCollections",
                __editorItemTitle: mock_invalid_collection.id
              }
            ]
          }
        ]
            ...
            theLinksPresentsInThisProductContextByVariations: [
              {
                ...
                __editorItemTitle: mock_valid_variation_1.name,
                extraCampToFilter_1: mock_valid_variation_1.values[0]
              }
            ]
          }
        ]
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByVariations: [
              {
                propertieToLinkOnCtx: "listOfVariations",
                __editorItemTitle: mock_valid_variation_2.name,
                extraCampToFilter_1: mock_valid_variation_2.values[0]
              }
            ]
          }
        ]
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByVariations: [
              {
                propertieToLinkOnCtx: "listOfVariations",
                __editorItemTitle: mock_invalid_variation.name,
                extraCampToFilter_1: mock_invalid_variation.values[0]
              }
            ]
          }
        ]
            ...
            theLinksPresentsInThisProductContextByProductField: [
              {
                ...
                __editorItemTitle: mock_specification_1.name,
                extraCampToFilter_1: mock_specification_1.values[0]
              }
            ]
          }
        ]
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByProductField: [
              {
                propertieToLinkOnCtx: "listOfProductFields",
                __editorItemTitle: mock_specification_2.name,
                extraCampToFilter_1: mock_specification_2.values[0]
              }
            ]
          }
        ]
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByProductField: [
              {
                propertieToLinkOnCtx: "listOfProductFields",
                __editorItemTitle: mock_invalid_specification.name,
                extraCampToFilter_1: mock_invalid_specification.values[0]
              }
            ]
          }
        ]
            ...
            theLinksPresentsInThisProductContextByProduct: [
              {
                ...
                __editorItemTitle: mock_valid_product_id
              }
            ]
          }
        ]
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByProduct: [
              {
                propertieToLinkOnCtx: "productId",
                __editorItemTitle: mock_invalid_product_id
              }
            ]
          }
        ]
            ...
            theLinksPresentsInThisProductContextByCategoryId: [
              {
                ...
                __editorItemTitle: mock_valid_category_id
              }
            ]
          }
        ]
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByCategoryId: [
              {
                propertieToLinkOnCtx: "categoryId",
                __editorItemTitle: mock_invalid_category_id
              }
            ]
          }
        ]
            ...
            theLinksPresentsInThisProductContextByBrand: [
              {
                ...
                __editorItemTitle: mock_valid_brand_id
              }
            ]
          }
        ]
        ...
        linksContainer: [
          {
            theLinksPresentsInThisProductContextByBrand: [
              {
                propertieToLinkOnCtx: 'brandId',
                __editorItemTitle: mock_invalid_brand_id
              }
            ]
          }
        ]
      ...
      const mock_collection_variation = generateCollection({
        ...
        linksContainer: [{
          theLinksPresentsInThisProductContextByVariations: [
            {
              propertieToLinkOnCtx: 'listOfVariations',
              __editorItemTitle: mock_variation_value.name,
              extraCampToFilter_1: mock_variation_value.values[0]
            }
          ]
        }]
