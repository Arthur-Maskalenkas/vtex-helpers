...
import { DataRefined, FieldDataRefined, FieldDiscountDataRefined } from '../remap-schema/_interfaces'
import { product_context_root } from '../remap-schema/_interfaces/product-context/custom_context'
...
export class RefinedData {
  ...
  private pickSellerData (): FieldDataRefined | null {
    const data = {
  ...
  private pickVariationData (): FieldDataRefined[] | null {
