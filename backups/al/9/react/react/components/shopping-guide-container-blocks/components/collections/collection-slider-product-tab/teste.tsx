          ...
          (
            <li className={styles.containerBlockCollectionProduct}>
              <a href={items[currentTab].linkButton}>
                <img className={styles.imageProduct} src={items[currentTab]?.src ?? 'https://lojasmarabrazqa.vtexassets.com/arquivos/banner-padrao-mobile-guia-de-compras.png'} alt={items[currentTab].__editorItemTitle} />
              </a>
