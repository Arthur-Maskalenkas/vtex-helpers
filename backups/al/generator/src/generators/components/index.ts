...
import { GeneratorComponentOperations, GeneratorComponentQuestions } from "./types"
...
module.exports = (plop: NodePlopAPI) => {
  plop.setGenerator('Gerador De Componentes', {
    ...
    actions: function (data) {
      ...
      const { attributes } = data as GeneratorComponentQuestions

      const { add, modify } = operations as GeneratorComponentOperations
