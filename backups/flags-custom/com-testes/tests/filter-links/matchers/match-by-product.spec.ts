...
describe("MatchByProduct", () => {
  describe('Matchs', () => {
    it('Should Match By Value', () => {
      ...
      expect(result).toStrictEqual({
        HTMLMatch: {
          "data-custom--match-by-product-attr--value-any_value": true
        }
      })
    })
  ...
  describe('HTML', () => {
    ...
    it('Should return title HTML tag if __editorItemTitle is passed by link', () => {
      ...
      expect(result).toMatchObject({
        HTMLMatch: {
          "data-custom--match-by-product-attr-site-editor--name-any_title": true
        }
      })
    })
