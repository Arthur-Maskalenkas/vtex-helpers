...
export class CMSHelper {
  ...
  public static myCurrentLocationIs(pathToVerify: 'fale-conosco' | 'perguntas-frequentes') {
    return window?.location?.href?.includes(pathToVerify)
  }
      ...
      items: {
        ...
        properties: {
          ...
          titleContent: {
            type: "string",
            title: "Titulo Imagem",
            description: 'Titulo que será exibido após o usuario passar o mouse na imagem.'
          },

          href: {
            type: "string",
            title: 'Link redirecionamento',
            description: 'Link que o usuario será redirecionado após clicar. Caso não seja preenchido, o usuario não será redirecionado. Exemplo: \'/sobre-nos\''
          },
