// Tudo em javascript é objeto. A palavra class é uma syntax suggar. A implementação da classe vira objeto.

// Em javascript a herança é gerada a partir do prototype, e essa forma de herança é também chamada de herança de prototipos.

// quando tentamos procurar pela existencia de um atributo/metodo em um objeto, o motor do javascript vai primeiro verificar o objeto, e caso ela não exista ele vai verificar o prototipo dele, e caso ainda não existir, vai procurar no protototipo do prototipo, até o ultimo protitipo. Caso chegue no ultimo e não encontre o atributo, vai retornar undefined.

// o prototype chain é o processo de navegar entre classes derivadas até o valor raiz da instancia.
...
// ? __proto__ nada mais é do que a referncia ao prototipo dele
...
//  ? o __proto__ de Object.prototype é null. Ou seja, tudo herda de NULL
...
// ? o primeiro proto tem o prototype da propria função
