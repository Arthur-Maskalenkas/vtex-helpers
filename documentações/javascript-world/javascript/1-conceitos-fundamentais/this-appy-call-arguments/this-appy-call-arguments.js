...
watch(__filename, file.watch.bind(file)) // substituir o this de dentro da função watch

// bind - muda o this. primeiro 
...
// Utilizando bind para fixar o valor do 'this' e também definir argumentos predefinidos
const greetPersonWithMessage = greet.bind(person, 'Welcome');

greetPersonWithMessage(); // Output: Welcome, John Doe
